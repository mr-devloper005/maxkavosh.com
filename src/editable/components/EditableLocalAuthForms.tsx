...
const inputClass = 'h-12 rounded-md border border-slate-300 bg-white px-4 text-base font-bold text-slate-950 outline-none transition placeholder:text-slate-500 focus:border-[var(--slot4-blue)] focus:ring-2 focus:ring-blue-100'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[var(--slot4-blue,#1f6f9d)] px-6 text-sm font-black uppercase tracking-[0.14em] text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[var(--slot4-blue-dark,#0f4f76)] disabled:opacity-60'
